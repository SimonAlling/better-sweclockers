...
export const preferences = {
    ...
    edit_mode: {
        ...
        keyboard_shortcuts: `Kortkommandon för att skicka (<kbd>Ctrl</kbd> + <kbd>S</kbd>), förhandsgranska (<kbd>Ctrl</kbd> + <kbd>P</kbd>) etc`,
        keyboard_shortcuts_description: `Skicka, förhandsgranska etc med tangentbordet`,
