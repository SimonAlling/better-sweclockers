...
//*****************************************//
// Copyright 2013-2017 Simon Alling        //
...
var BSC = {
    ...
    darkThemeURL: "https://blargmode.se/files/swec_dark_theme/style.css",
    smileyURLs: {
    ...
    darkThemeCached: '.articleNavi .head{padding-top:3px}.bbColor[style="color: blue;"]{color:#09F!important}.spoilerContent .bbVideoYoutube:first-child{clear:both}.articleNavi .quick a,.bbIns,.bbMark,.pages a{border-radius:3px!important}.bbSpoiler .spoilerHeader{float:right;margin-top:7px;margin-right:5px}.bbIns,.bbMark{padding:0 1px!important}.header,.header .shadow,.menuItem,.searchField .fieldWrap,.searchField input,.signinDialog input,body{background-color:#000!important;color:#8A8A8A!important}.header,.header .shadow,.menuItem,body{background-image:url(https://blargmode.se/files/sweclockers_dark_theme/grain_dark.png)!important}.bbIns,.bbMark{background-color:#713a11!important}.articleKeywords a,.articleNavi .pageButton:hover,.bbTable th,.filterLinks .filterLink.isSelected,.forumForm .body,.forumList .numThreads,.forumList .numViews,.forumList .title,.forumPost,.forumResultPost,.infoBox,.marketList .status,.marketList .title,.memberTable .cell,.pages .isCurrent,.pages a.isCurrent:hover,.pages a.isCurrent:hover .label,.pages a:hover,.postBox,.signinDialog .inner,.stepWidget .stepItem.isSelected,.tanukiCombobox .tcbSelectedItem,.threadList .numReplies,.threadList .select,.threadList .status,.threadList .title,input,select,textarea{background-color:#222!important}#Better_SweClockers fieldset,#betterSwecFilterSettingsList,.bbPoll .inner,.bbQuote,.bbSpoiler .spoilerFrame,.footer .top,.forumForm input,.forumForm textarea,.forumList .lastReply,.forumList .lastThread,.forumList .link,.forumList .numReplies,.forumList .status,.forumPost .details,.forumPost .profile,.forumResultPost .dateline,.infoTextWindow,.mainContent,.marketList .date,.marketList .price,.memberTable .alt2,.postBox .shortcut,.quickReply textarea,.showFrame,.tanukiCombobox .tcbTriggerFrame,.threadList .lastReply,.threadList .numViews,.threadMap .postElement{background-color:#111!important}.threadList .isSticky .numReplies,.threadList .isSticky .select,.threadList .isSticky .status,.threadList .isSticky .title{background-color:#272727!important}.threadList .isSelected .cell{background-color:#200e00!important}.threadList .isSticky .lastReply,.threadList .isSticky .numViews{background-color:#191919!important}.mainMenu .isSelected{background-color:#08090a!important;background-image:none!important}img[src*="/image/diagram/"]{background-color:#CCC}:not(.arrow):not(.handle){border-color:#333!important}.mainWidget .body .divider{border-color:#43413d!important}.bbTable thead .bbParagraph,.forumTable th .numReplies,.pages a:hover>.label,.postBox .head .title,.tanukiCombobox .tcbSelectedItem{color:#EBEBEB!important}#Better_SweClockers input:not(.button),#Better_SweClockers textarea,.bbList,.bbParagraph,.bbPre,.bbcode h1,.bbcode h2,.bbcode h3,.bbcode h4,.bbcode h5,.bbcode h6,.contactInfo,.expanderHeader,.feedItem,.forumForm,.forumPost .quoteHead,.forumPost .showFrame,.forumPost .title,.forumResultPost,.forumRules,.forumTable tbody .numThreads,.forumTable td .by,.forumTable td .date,.forumTable td .descr,.forumTable td .numReplies,.forumTable td .time,.forumTable td.numReplies,.galleryFiles,.galleryFiles input,.galleryForm,.galleryForm input,.galleryForm select,.galleryForm textarea,.header .profile .options,.infoText,.infoTextWindow,.marketAcceptRules,.marketFilterBox input,.marketFilterBox select,.marketForm,.marketForm input,.marketForm select,.marketForm textarea,.marketList .row,.memberTable,.ninjaSearch h5,.pages .isCurrent .label,.profileHeader .label,.quickReply label,.searchField input,.signinDialog,.signinDialog input,.spoilerPlaceholder,.tanukiSelect select,.tanukiTextarea textarea,.tanukiTextbox input,label,select{color:#8A8A8A!important}.prisjaktPopular .ppPrice{color:#6f867e}#proofArticle,* a,.feedMore,.footer .top a::before,.forumList .lastThread h3,.galleryBody .commentLink::before,.header .profile .hasUnread a,.mwLabel.mwComments,.plLabel.plComments{color:#c15200!important}#proofArticle:hover,* a:hover,.feedMore:hover,.footer .top a::before:hover,.forumList .lastThread h3:hover,.galleryBody .commentLink::before:hover,.mwLabel.mwComments:hover,.plLabel.plComments:hover{color:#ff8d38!important}.articleCommentsWidget .boxAction .actionLabel,.forumPost .postHeader .headerLink,.forumTable .title h3 a,.mainWidget .label,.plHead a,.pushListInternal .link .label,.slide a,.socialWidget a{color:#EBEBEB!important}.commentsBubble,.commentsBubble:hover,.errorBox a,.footer .bottom a,.forumResultPost .postHeader .threadTitle .label,.mainWidget h5 a,.mwReadmore a,.pushListInternal .head h5 a{color:#FFF!important}.pushListInternal .head a{color:#CCC!important}.link .label,.pushListExternal a span{color:#6A6A6A!important}.articleNavi .isCurrent a,.galleryItem a,.header a,.hotGallery a,.newsList .bbParagraph a,.pages a,.popularGalleries a,.tagSection h2 a,.threadMap .postElement a,.videoPush a{color:#8A8A8A!important}.button,.galleryFileEditor button,.tanukiButton,.taunkiButton,a.button{color:#DDD!important}.mwLabel,.mwLabel:hover,.plLabel,.plLabel:hover{color:#d8d8d8!important}.commentsWidget .mwReadmore{text-decoration:none!important}.commentsWidget .mwReadmore a:hover{text-decoration:underline!important}.pln{color:#8A8A8A!important}.pun{color:#BBB!important}.kwd{color:#0050FF!important}.lit{color:#EBEBEB!important}.header .main{background:linear-gradient(top,#08090a,#141416 98%,#272829)!important;background:-webkit-gradient(linear,left top,left bottom,from(#08090a),color-stop(98%,#141416),to(#272829))!important;background:-webkit-linear-gradient(top,#08090a,#141416 98%,#272829)!important;background:-moz-linear-gradient(top,#08090a,#141416)!important;background:-o-linear-gradient(top,#08090a,#141416 98%,#272829)!important;background:linear-gradient(top,#08090a,#141416 98%,#272829)!important}.bbImage .caption{background-color:rgba(0,0,0,.8)!important}.postBox .head{background:-webkit-linear-gradient(top,#979590,#84827d 60%,#7a7873)!important;background:-moz-linear-gradient(top,#979590,#7a7873)!important;background:-o-linear-gradient(top,#979590,#84827d 60%,#7a7873)!important;background:linear-gradient(top,#979590,#84827d 60%,#7a7873)!important}.bbExpander>.expanderFrame>.expanderFade,.bbQuote.isExpandable>.quoteFrame>.quoteFade{background:-moz-linear-gradient(top,rgba(17,17,17,0)0,rgba(17,17,17,.5)25%,rgba(17,17,17,1)100%);background:-webkit-gradient(linear,left top,left bottom,color-stop(0%,rgba(17,17,17,0)),color-stop(25%,rgba(17,17,17,.5)),color-stop(100%,rgba(17,17,17,1)));background:-webkit-linear-gradient(top,rgba(17,17,17,0)0,rgba(17,17,17,.5)25%,rgba(17,17,17,1)100%);background:-o-linear-gradient(top,rgba(17,17,17,0)0,rgba(17,17,17,.5)25%,rgba(17,17,17,1)100%);background:linear-gradient(to bottom,rgba(17,17,17,0)0,rgba(17,17,17,.5)25%,rgba(17,17,17,1)100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#00111111\', endColorstr=\'#111111\', GradientType=0)}.forumPost .postHeader .cell{background-color:#3e3e3e!important;background-image:-webkit-linear-gradient(top,#3e3e3e,#353535)!important;background-image:-moz-linear-gradient(top,#3e3e3e,#353535)!important;background-image:-o-linear-gradient(top,#3e3e3e,#353535)!important;background-image:linear-gradient(to bottom,#3e3e3e,#353535)!important}.forumPost.isAuthor .postHeader .cell{background-color:#75421d!important;background-image:-webkit-linear-gradient(top,#75421d,#623e24)!important;background-image:-moz-linear-gradient(top,#75421d,#623e24)!important;background-image:-o-linear-gradient(top,#75421d,#623e24)!important;background-image:linear-gradient(to bottom,#75421d,#623e24)!important}.button,.galleryFileEditor button,.tanukiButton,.taunkiButton{background-color:#3e3e3e!important;background-image:-webkit-linear-gradient(top,#3e3e3e,#353535)!important;background-image:-moz-linear-gradient(top,#3e3e3e,#353535)!important;background-image:-o-linear-gradient(top,#3e3e3e,#353535)!important;background-image:linear-gradient(to bottom,#3e3e3e,#353535)!important}.button:hover,.galleryFileEditor button:hover,.tanukiButton:hover,.taunkiButton:hover{background-color:#2a2a2a!important;background-image:-webkit-linear-gradient(top,#2a2a2a,#262626)!important;background-image:-moz-linear-gradient(top,#2a2a2a,#262626)!important;background-image:-o-linear-gradient(top,#2a2a2a,#262626)!important;background-image:linear-gradient(to bottom,#2a2a2a,#262626)!important}.prisjaktPopular{background-color:#1d3c49!important;background-image:-webkit-linear-gradient(top,#1d3c49,#204150)!important;background-image:-moz-linear-gradient(top,#1d3c49,#204150)!important;background-image:-o-linear-gradient(top,#1d3c49,#204150)!important;background-image:linear-gradient(to bottom,#1d3c49,#204150)!important}.pages .icon,.sideMenu .icon{background-image:url(https://blargmode.se/files/sweclockers_dark_theme/spritemap.png)!important}img[src*="/artikel/diagram/"]{filter:invert(85%);-webkit-filter:invert(85%);-o-filter:invert(85%);-ms-filter:"invert(85%)";background:none!important}@-moz-document url-prefix(){.bbPre.showFrame,.bbSpoiler .spoilerFrame,.bbcode .bbQuote,.bbcode hr.bbHr{border:1px solid #333!important;border-top-color:#000!important;border-left-color:#000!important}}',
    darkThemeCacheDate: new Date("Sep 26, 2017 14:20:00")
};
