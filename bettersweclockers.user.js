...
function canInsertAdvancedControlPanel() {
    return !!qSel(ACPInsertionPointSelector(BSC.settings.ACPInsertionPoint));
}
...
function insertAdvancedControlPanel() {
    ...
    if (!!TAFieldset) {
        var qSelector = ACPInsertionPointSelector(BSC.settings.ACPInsertionPoint);
...
function prepare() {
    try {
        ...
        if (optionIsTrue("insertFavoriteLinks")) {
